const AVAILABLE_FONT_COLORS = ["#FFF", "#000"],
  AVAILABLE_FONT_SIZES = ["14px", "24px", "36px", "48px", "72px", "96px",
    "144px"
  ],
  AVAILABLE_FONTS = ["Arial", "Verdana", "Helvetica", "Tahoma", "Trebuchet MS",
...
function shiftModelValue(model, value, source) {
  let currentIndex = source.findIndex((element, index) => (element === model[
    value]));
